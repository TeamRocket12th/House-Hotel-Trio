<template>
  ...
  >
    <div
      ...
      :class="
        formValue
          ? 'container absolute left-1/2  top-[155%]  z-30 mx-auto flex  translate-x-[-50%] translate-y-[-50%] flex-wrap md:top-[60%]  md:translate-y-[-50%] lg:left-1/2 lg:top-1/2 lg:translate-x-[-50%] lg:translate-y-[-50%]'
