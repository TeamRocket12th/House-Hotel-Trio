      ...
      <div class="px-[65px] pb-[26px] pt-[50px]">
        <form action="" class="">
          <label>
            ...
            <input type="text" id="name" class="mt-[7px] h-[38px] w-[315px] p-2 outline-none" placeholder="請填寫預定人姓名"
          ...
          <div v-if="bookingDate.totalDays" class="mt-4 w-full border-b border-[#949C7C] pb-[14px] text-[#949C7C]">
            <p v-if="bookingDate.totalDays > 0 &&
            ...
            <span v-if="bookingDate.totalNights < 0 || bookingDate.totalNights === 0"
              class="text-yellow-400">請先輸入預定日期</span>
          </div>
